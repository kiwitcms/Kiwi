    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=models.deletion.CASCADE,
                                           to='testplans.TestPlan')),
                ('tag', models.ForeignKey(on_delete=models.deletion.CASCADE, to='management.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='PlanType',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE,
                                    related_name='myplans', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='testplan',
            name='parent',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=models.deletion.CASCADE,
                                    related_name='plan', to='management.Product'),
        ),
        migrations.AddField(
            model_name='testplan',
            name='product_version',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE,
                                    related_name='plans', to='management.Version'),
        ),
        migrations.AddField(
            model_name='testplan',
            name='tag',
            field=models.ManyToManyField(related_name='plan', through='testplans.TestPlanTag',
                                         to='management.Tag'),
        ),
        migrations.AddField(
            model_name='testplan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_column='isactive',
                                                  db_index=True,
                                                  default=True)),
                ('extra_link', models.CharField(blank=True, default=None, max_length=1024,
                                                null=True)),
