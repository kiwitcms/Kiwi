...
class TestBuildCreate(XmlrpcAPIBaseTest):
    ...
    def setUpTestData(cls):
        super(TestBuildCreate, cls).setUpTestData()
...
class TestBuildUpdate(XmlrpcAPIBaseTest):
    ...
    @classmethod
    def setUpTestData(cls):
        super(TestBuildUpdate, cls).setUpTestData()
        cls.admin = UserFactory()
...
class TestBuildGet(XmlrpcAPIBaseTest):
    ...
    @classmethod
    def setUpTestData(cls):
        super(TestBuildGet, cls).setUpTestData()
        cls.product = ProductFactory()
...
class TestBuildGetCaseRuns(XmlrpcAPIBaseTest):
    ...
    @classmethod
    def setUpTestData(cls):
        super(TestBuildGetCaseRuns, cls).setUpTestData()
        cls.product = ProductFactory(name='Nitrate')
...
class TestBuildCheck(XmlrpcAPIBaseTest):
    ...
    @classmethod
    def setUpTestData(cls):
        super(TestBuildCheck, cls).setUpTestData()
        cls.product = ProductFactory()
