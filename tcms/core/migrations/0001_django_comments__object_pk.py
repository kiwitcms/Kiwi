...
class DjangoCommentsAlterField(migrations.AlterField):
    """
        ...
        model/table instead of the `tcms.core` one! We need this because
        when Django is executing migrations it will record them as
        app_label|migration_name in the database.
