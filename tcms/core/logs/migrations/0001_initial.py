    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(related_name='content_type_set_for_tcmslogmodel', verbose_name='content type', blank=True, to='contenttypes.ContentType', null=True)),
