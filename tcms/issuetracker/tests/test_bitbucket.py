...
from tcms.issuetracker.bitbucket import BitBucketAPI, BitBucket
...
class TestBitBucketIntegration(APITestCase):
    ...
    def _fixture_setup(self):
        ...
        self.execution_1.run.summary = "Automated TR for BitBucket integration on " + \
                                       timezone.now().isoformat()
        self.execution_1.run.save()

        self.component = ComponentFactory(name='BitBucket integration',
    ...
    def test_report_issue_from_test_execution_empty_baseurl_exception(self):
        ...
        result = self.rpc_client.Bug.report(self.execution_1.pk, integration.bug_system.pk)
