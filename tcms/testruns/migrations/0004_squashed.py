    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build', models.ForeignKey(on_delete=models.deletion.CASCADE,
                                            to='management.Build')),
                ('case', models.ForeignKey(on_delete=models.deletion.CASCADE,
                                           related_name='case_run', to='testcases.TestCase')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run', models.ForeignKey(on_delete=models.deletion.CASCADE,
                                          related_name='cc_list', to='testruns.TestRun')),
                ('user', models.ForeignKey(db_column='who',
                                           on_delete=models.deletion.CASCADE,
                                           to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='testrun',
            name='cc',
            field=models.ManyToManyField(through='testruns.TestRunCC', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='testrun',
            name='default_tester',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE,
                                    related_name='default_tester', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='testrun',
            name='manager',
        ...
        migrations.AddField(
            ...
            name='plan',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE,
                                    related_name='run', to='testplans.TestPlan'),
        ),
        migrations.AddField(
            model_name='testrun',
            name='product_version',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE,
                                    related_name='version_run', to='management.Version'),
        ),
        migrations.AddField(
            model_name='testrun',
            name='tag',
            field=models.ManyToManyField(related_name='run', through='testruns.TestRunTag',
                                         to='management.Tag'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='run',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE,
                                    related_name='case_run', to='testruns.TestRun'),
        ),
        migrations.AddField(
            model_name='testcaserun',
            name='tested_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE,
                                    related_name='case_run_tester', to=settings.AUTH_USER_MODEL),
        ),
