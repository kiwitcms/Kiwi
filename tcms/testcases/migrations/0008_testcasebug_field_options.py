...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='testcasebugsystem',
            name='tracker_type',
            field=models.CharField(default='IssueTrackerType', help_text='This determines how KiwiTestPad integrates with the IT system', max_length=128, verbose_name=b'Type'),
        ),
    ]
