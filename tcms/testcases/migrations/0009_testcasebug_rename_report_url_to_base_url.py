...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='base_url',
            field=models.CharField(help_text=b'Base URL, for example <strong>https://bugzilla.example.com</strong>!\nLeave empty to disable!\n', max_length=1024, null=True, verbose_name=b'Base URL', blank=True),
        ),
