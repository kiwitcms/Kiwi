...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='case_run',
            field=models.ForeignKey(related_name='case_run_bug', default=None, blank=True,
                                    to='testruns.TestCaseRun', null=True,
        ...
        migrations.AddField(
            model_name='testcaseattachment',
            name='case',
            field=models.ForeignKey(related_name='case_attachment', default=None,
                                    to='testcases.TestCase', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='testcaseattachment',
            name='case_run',
            field=models.ForeignKey(related_name='case_run_attachment', default=None,
                                    to='testruns.TestCaseRun', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='testcase',
            name='attachment',
        ...
        migrations.AddField(
            model_name='testcase',
            name='default_tester',
            field=models.ForeignKey(related_name='cases_as_default_tester', blank=True,
        ...
        migrations.AddField(
            model_name='testcase',
            name='plan',
            field=models.ManyToManyField(related_name='case', through='testcases.TestCasePlan',
        ...
        migrations.AddField(
            model_name='testcase',
            name='reviewer',
            field=models.ForeignKey(related_name='cases_as_reviewer', to=settings.AUTH_USER_MODEL,
                                    null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='testcase',
            name='tag',
            field=models.ManyToManyField(related_name='cases', through='testcases.TestCaseTag',
                                         to='management.TestTag'),
        ),
        migrations.AddField(
            model_name='contact',
            name='content_type',
            field=models.ForeignKey(related_name='content_type_set_for_contact',
