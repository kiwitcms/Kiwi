    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_owner', models.ForeignKey(related_name='initialowner', db_column='initialowner', to=settings.AUTH_USER_MODEL, null=True)),
                ('initial_qa_contact', models.ForeignKey(related_name='initialqacontact', db_column='initialqacontact', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'db_table': 'components',
            },
